...
export class CoursesResolver {
  ...
  createCourse(@Args('createCourseInput', new ValidationPipe()) createCourseInput: CreateCourseInput) {
  ...
  updateCourse(@Args('updateCourseInput', new ValidationPipe()) updateCourseInput: UpdateCourseInput) {
