...
export class addOptionsInSomeEntities1653258996093 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "trivia" ADD "type" character varying NOT NULL DEFAULT 'TRIVIA'`);
        await queryRunner.query(`ALTER TABLE "trivia" ADD "source" character varying`);
